...
if DevHaider:get(MaxTeam.."Haider:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevHaider:sadd(MaxTeam.."Haider:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevHaider:srem(MaxTeam.."Haider:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevHaider:del(MaxTeam.."Haider:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevHaider:smembers(MaxTeam.."Haider:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevHaider:get(MaxTeam.."Haider:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
MaxTeamName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if MaxTeamName then 
MaxTeamNames = DevHaider:smembers(MaxTeam.."Haider:Mute:Names"..msg.chat_id_) or ""
if MaxTeamNames and MaxTeamNames[1] then 
for i=1,#MaxTeamNames do 
if MaxTeamName:match("(.*)("..MaxTeamNames[i]..")(.*)") then 
...
DevHaider:set(MaxTeam.."Haider:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevHaider:del(MaxTeam.."Haider:Lock:MuteNames"..msg.chat_id_)
end
end
end
