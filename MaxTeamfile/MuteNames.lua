...
if DevAbs:get(Latvia.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(Latvia.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(Latvia.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(Latvia.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(Latvia.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(Latvia.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
LatviaName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if LatviaName then 
LatviaNames = DevAbs:smembers(Latvia.."Abs:Mute:Names"..msg.chat_id_) or ""
if LatviaNames and LatviaNames[1] then 
for i=1,#LatviaNames do 
if LatviaName:match("(.*)("..LatviaNames[i]..")(.*)") then 
...
DevAbs:set(Latvia.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(Latvia.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
