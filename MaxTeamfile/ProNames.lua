...
if Manager(msg) then
if DevHaider:get(MaxTeam.."Haider:Lock:ProNames"..msg.chat_id_) then
local Txt = text:match("^وضع توحيد (.*)$") or text:match("^ضع توحيد (.*)$")
send(msg.chat_id_, msg.id_,'⌁︙تم تعيين ↫ '..Txt..' كتوحيد للمجموعه')
DevHaider:set(MaxTeam.."Haider:ProNames:Txt"..msg.chat_id_,Txt)
else
...
DevHaider:set(MaxTeam.."Haider:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevHaider:get(MaxTeam.."Haider:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevHaider:get(MaxTeam.."Haider:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevHaider:get(MaxTeam.."Haider:ProNames:Num"..msg.chat_id_) or 5
...
if DevHaider:get(MaxTeam.."Haider:Lock:ProNames"..msg.chat_id_) and DevHaider:get(MaxTeam.."Haider:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevHaider:get(MaxTeam.."Haider:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevHaider:srem(MaxTeam..'Haider:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevHaider:get(MaxTeam.."Haider:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevHaider:get(MaxTeam.."Haider:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(UserNum) == tonumber(ProNamesTxt) or tonumber(UserNum) > tonumber(ProNamesTxt)) then 
DevHaider:sadd(MaxTeam..'Haider:Muted:'..msg.chat_id_, msg.sender_user_id_)
DevHaider:del(MaxTeam.."Haider:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevHaider:incrby(MaxTeam.."Haider:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌁︙عذرا عزيزي ↫ ["..result.first_name_.."](https://t.me/"..(result.username_ or "Dev_Prox")..")\n⌁︙عليك وضع التوحيد ↫ `"..DevHaider:get(MaxTeam.."Haider:ProNames:Txt"..msg.chat_id_).."` بجانب اسمك\n⌁︙عدد المحاولات المتبقيه ↫ "..(tonumber(ProNamesTxt) - tonumber(UserNum)).."")
end
end
end
end,nil)
...
DevHaider:set(MaxTeam.."Haider:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevHaider:del(MaxTeam.."Haider:Lock:ProNames"..msg.chat_id_)
end
end
